...
function bindButtons1() {
    ...
    document.getElementById('SubmitGroupQuery').addEventListener('click', function(input){
        ...
        Request.addEventListener('load', function() {
            ...
            if (Request.status >= 200 && Request.status < 400) {
                var Response = xmlToJSON1.parseString(Request.responseText);
                ReturnedInfo1(Response);
...
function ReturnedInfo1(Response) {
